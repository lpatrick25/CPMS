            ...
            <form id="addItemForm" class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <small id="descriptionError" class="form-text text-danger d-none"></small>
                    </div>

                    <!-- Item Unit -->
                    <div class="form-group mb-4">
                        <label for="unit_id">Item Unit: <span class="text-danger">*</span></label>
                        ...
                        <small id="unitError" class="form-text text-danger d-none"></small>
                    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response) {
                        ...
                        $('#updateForm').find('select[id=unit_id]').val(response.unit_id);
